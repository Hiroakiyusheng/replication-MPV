** Generate Table 2: Experience Effects and Consumption (PSID)
...
outreg2 using "../../Tables/table_2.tex", excel title (Dependent: Log Consumption Value) ctitle (Consumption_All) keep(exp_personal_lagged_1) dec(3) nonotes nocons replace 
...
outreg2 using "../../Tables/table_2.tex", excel title (Dependent: Log Consumption Value) ctitle (Consumption_All) keep( exp_state_nat_lagged_1) dec(3) nonotes nocons append
...
outreg2 using "../../Tables/table_2.tex", excel title (Dependent: Log Consumption Value) ctitle (Consumption_All) keep(exp_personal_lagged_1 exp_state_nat_lagged_1 ) dec(3) nonotes nocons append 
...
outreg2 using "../../Tables/table_2.tex", excel title (Dependent: Log Consumption Value) ctitle (Consumption_All) keep(exp_personal_nat_l3) dec(3) nonotes nocons append 
...
outreg2 using "../../Tables/table_2.tex", excel title (Dependent: Log Consumption Value) ctitle (Consumption_All) keep( exp_state_nat_lagged_l3) dec(3) nonotes nocons  append 
...
outreg2 using "../../Tables/table_2.tex", excel title (Dependent: Log Consumption Value) ctitle (Consumption_All) keep(exp_personal_nat_l3 exp_state_nat_lagged_l3 ) dec(3) nonotes nocons append 
