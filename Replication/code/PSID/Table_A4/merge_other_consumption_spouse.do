/************************************************************************************************
  ...
  Input: 1. "psid_new_with_exp_fzero_debt_lagged_spouse"
         2. Raw PSID data files on consumption: "../../../raw/PSID/consumption/con_[year].dta"

		 
  Output: "psid_new_with_exp_allf_lagged_spouse.dta"
************************************************************************************************/

clear
set more off

 use "psid_new_with_exp_fzero_debt_lagged_spouse.dta"
  sort INTERVIEW_ID year
  merge m:1 INTERVIEW_ID year using "../../../raw/PSID/consumption/con_1999.dta", assert(1 3) nogen
  merge m:1 INTERVIEW_ID year using "../../../raw/PSID/consumption/con_2001.dta", assert(1 3) nogen
  merge m:1 INTERVIEW_ID year using "../../../raw/PSID/consumption/con_2003.dta", assert(1 3) nogen
  merge m:1 INTERVIEW_ID year using "../../../raw/PSID/consumption/con_2005.dta", assert(1 3) nogen
  merge m:1 INTERVIEW_ID year using "../../../raw/PSID/consumption/con_2007.dta", assert(1 3) nogen
  merge m:1 INTERVIEW_ID year using "../../../raw/PSID/consumption/con_2009.dta", assert(1 3) nogen
  merge m:1 INTERVIEW_ID year using "../../../raw/PSID/consumption/con_2011.dta", assert(1 3) nogen
  merge m:1 INTERVIEW_ID year using "../../../raw/PSID/consumption/con_2013.dta", assert(1 3) nogen
  merge m:1 INTERVIEW_ID year using "../../../raw/PSID/consumption/con_2015.dta", assert(1 3) nogen
  merge m:1 INTERVIEW_ID year using "../../../raw/PSID/consumption/con_2017.dta"
  drop if _merge==2
  drop _merge
...
/* Combine consumption variables */
 ...
 save "psid_new_with_exp_allf_lagged_spouse.dta", replace
