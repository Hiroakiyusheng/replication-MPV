/************************************************************************************************
  ...
  Input: 1. "psid_new_with_exp_spouses.dta"
  ...
  Output: "psid_new_with_exp_fzero_debt_lagged_spouse.dta"
************************************************************************************************/
...
/* Merge in debt variables */
 use "psid_new_with_exp_spouses.dta", clear
  sort INTERVIEW_ID year
  merge m:1 INTERVIEW_ID year using "../../../raw/PSID/wealth/debt_1984.dta", assert(1 3) nogen
  merge m:1 INTERVIEW_ID year using "../../../raw/PSID/wealth/debt_1989.dta", assert(1 3) nogen
  merge m:1 INTERVIEW_ID year using "../../../raw/PSID/wealth/debt_1994.dta"
    drop if _merge == 2 /* Latino Sample */
	drop _merge
  merge m:1 INTERVIEW_ID year using "../../../raw/PSID/wealth/debt_1999.dta", assert(1 3) nogen
  merge m:1 INTERVIEW_ID year using "../../../raw/PSID/wealth/debt_2001.dta", assert(1 3) nogen
  merge m:1 INTERVIEW_ID year using "../../../raw/PSID/wealth/debt_2003.dta", assert(1 3) nogen
  merge m:1 INTERVIEW_ID year using "../../../raw/PSID/wealth/debt_2005.dta", assert(1 3) nogen
  merge m:1 INTERVIEW_ID year using "../../../raw/PSID/wealth/debt_2007.dta", assert(1 3) nogen
  merge m:1 INTERVIEW_ID year using "../../../raw/PSID/wealth/debt_2009.dta", assert(1 3) nogen
  merge m:1 INTERVIEW_ID year using "../../../raw/PSID/wealth/debt_2011.dta", assert(1 3) nogen
  merge m:1 INTERVIEW_ID year using "../../../raw/PSID/wealth/debt_2013.dta", assert(1 3) nogen
  merge m:1 INTERVIEW_ID year using "../../../raw/PSID/wealth/debt_2015.dta", assert(1 3) nogen
  merge m:1 INTERVIEW_ID year using "../../../raw/PSID/wealth/debt_2017.dta"
    drop if _merge == 2 
	drop _merge
...
/* Clean debt variables */
  ...
  sort INTERVIEW_ID year
  merge m:1 INTERVIEW_ID year using "../../../raw/PSID/wealth/wealth_sub_1984.dta", assert(1 3) nogen
  merge m:1 INTERVIEW_ID year using "../../../raw/PSID/wealth/wealth_sub_1989.dta", assert(1 3) nogen
  merge m:1 INTERVIEW_ID year using "../../../raw/PSID/wealth/wealth_sub_1994.dta", assert(1 3) nogen
  merge m:1 INTERVIEW_ID year using "../../../raw/PSID/wealth/wealth_sub_1999.dta", assert(1 3) nogen
  merge m:1 INTERVIEW_ID year using "../../../raw/PSID/wealth/wealth_sub_2001.dta", assert(1 3) nogen
  merge m:1 INTERVIEW_ID year using "../../../raw/PSID/wealth/wealth_sub_2003.dta", assert(1 3) nogen
  merge m:1 INTERVIEW_ID year using "../../../raw/PSID/wealth/wealth_sub_2005.dta", assert(1 3) nogen
  merge m:1 INTERVIEW_ID year using "../../../raw/PSID/wealth/wealth_sub_2007.dta", assert(1 3) nogen
  merge m:1 INTERVIEW_ID year using "../../../raw/PSID/wealth/wealth_sub_2009.dta", assert(1 3) nogen
  merge m:1 INTERVIEW_ID year using "../../../raw/PSID/wealth/wealth_sub_2011.dta", assert(1 3) nogen
  merge m:1 INTERVIEW_ID year using "../../../raw/PSID/wealth/wealth_sub_2013.dta", assert(1 3) nogen
  merge m:1 INTERVIEW_ID year using "../../../raw/PSID/wealth/wealth_sub_2015.dta", assert(1 3) nogen
  merge m:1 INTERVIEW_ID year using "../../../raw/PSID/wealth/wealth_sub_2017.dta"
      drop if _merge == 2 
	drop _merge
...
/* Combine the wealth sub-categories */
  ...
  save "psid_new_with_exp_fzero_debt_lagged_spouse.dta", replace
