...
function save_solve_dg_output(delta_grid,con, ass, assi, val, choice, inc)
    ...
    tag = string("solve_delta_grid_101_lam_e_72_lam_n_82.jld2")
    tag = replace(tag,"0." => "")
...
D1 = jldopen("solve_delta_0-50_grid_51_lam_e_72_lam_n_82.jld2","r",mmaparrays=true)
D2 = jldopen("solve_delta_51-100_grid_50_lam_e_72_lam_n_82.jld2","r",mmaparrays=true)
